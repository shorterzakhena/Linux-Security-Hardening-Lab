...
For this lab, I worked with an Ubuntu Linux virtual machine in Oracle VirtualBox. The goal of the lab was to practice some basic Linux security and system administration tasks. I worked with users and groups, file permissions, the firewall, SSH, and basic security checks. I also took screenshots of my work and organized everything into a GitHub repository.
...
Used sudo ufwstatus verbose to verify the firewall.
